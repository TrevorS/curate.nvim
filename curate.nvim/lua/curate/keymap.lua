...
M.maps = {
  ["curate-status"] = {
    ...
    { "k", "route.abandon", "abandon change", rw = true },
    ...
    { "f", "sync.menu", "sync menu (fetch/pull/push)" },
    { "P", "sync.push_menu", "push menu (sticky --allow-new)" },
    { "e", "power.revset", "revset workbench" },
    { "Z", "power.menu", "power menu (duplicate/fix/…)" },
